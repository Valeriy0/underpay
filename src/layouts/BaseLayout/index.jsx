...
export const BaseLayout = ({ children, className, withMenu = false }) => {
  return (
    <div className="flex items-center justify-center bg-mainBg w-full h-full">
      <div className={`relative flex flex-col items-center justify-start w-screen h-screen max-w-[39rem] `}>
