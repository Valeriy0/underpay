...
export const Item = ({ id, backgroundImageUrl, name, isNew = false, topic }) => {
    ...
    return (
        <Link to={`/catalog/${id}`} className="relative flex-shrink-0 w-full flex flex-col justify-start h-full hover:opacity-80">
            {isNew && (
